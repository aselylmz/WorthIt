...
class TestEDAPipelineRunner:
    ...
    def test_run_eda_pipeline_reproducible_outputs(self, tmp_path):
        ...
        assert (output_dir / "autocorrelations.csv").exists()
        assert (output_dir / "stl_seasonality.csv").exists()
        assert (output_dir / "rolling_volatility.csv").exists()
        assert (output_dir / "arch_tests.csv").exists()
        assert (output_dir / "cross_correlation.csv").exists()
